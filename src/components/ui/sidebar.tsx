    ...
    return (
      ...
      >
        {isMobile ? (
          ...
          <img src={OttoLogo} alt="Automia" className="h-7 w-7 object-contain" />
        )}
...
const sidebarMenuButtonVariants = cva(
  // Keep this base as minimal as possible so individual usages (like AppSidebar)
  // can fully control padding, background, and spacing.
  "peer/menu-button flex w-full items-center overflow-hidden text-left text-sm outline-none ring-sidebar-ring focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
